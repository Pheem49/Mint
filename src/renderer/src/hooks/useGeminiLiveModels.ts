/**
 * hooks/useGeminiLiveModels.ts  (Desktop)
 *
 * Fetches the list of Gemini Live–capable models (BidiGenerateContent /
 * native-audio) via the Tauri `fetch_gemini_live_models` command, falling
 * back to the static GEMINI_LIVE_MODELS preset list on any error or when
 * no API key is set.
 */

...
export const PICTURES_DIR = path.join(os.homedir(), '.config', 'mint', 'Pictures')
export const INDEX_PATH = path.join(PICTURES_DIR, 'pictures.json')
...
function parseImageDataUri(dataUri?: string | null) {
...
export function saveChatImages(base64Image: string | string[], metadata: any = {}) {
...
export function listSavedPictures() {
    ensurePicturesDir()
    return readIndex()
